...
<html>
    ...
    <head>
        ...
        <meta
            ...
            />
        <title>Beibe - Funcionários</title>
        <!-- Bootstrap core CSS -->
        <link
            rel="stylesheet"
                ...
                <div class="col-md-2 p-0 bg-dark">
                    ...
                    <ul class="list-group list-group-flush pt-3 sticky-top">
                        <li class="bg-dark list-group-item list-group-item-action">
                            ...
                            <a href="AtendimentoServlet?action=listarAtendimentosUsuario">Atendimentos</a>
                        </li>
                        <li class="bg-dark list-group-item list-group-item-action">
                        ...
                        <div class="col-md-12">
                            <div class="card h-100 border-white shadow-sm">
                                <div class="card-body">
                                    ...
                                    <c:if test="${ sessionScope.login.perfil eq 'C' }" var="res">
                                        <a class="btn btn-primary mb-3" href="AtendimentoServlet?action=novoAtendimentoForm">Novo atendimento</a>
                                    </c:if>
                                    <table class="table">
                                        <thead>
                                            <tr>
